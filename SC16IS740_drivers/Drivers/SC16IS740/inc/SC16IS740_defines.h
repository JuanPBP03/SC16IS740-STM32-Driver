...
#define SC16IS740_IER_ADDR_REGSEL					(SC16IS740_IER_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_FCR_ADDR_REGSEL					(SC16IS740_FCR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_IIR_ADDR_REGSEL					(SC16IS740_IIR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_LCR_ADDR_REGSEL					(SC16IS740_LCR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_MCR_ADDR_REGSEL					(SC16IS740_MCR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_LSR_ADDR_REGSEL					(SC16IS740_LSR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_MSR_ADDR_REGSEL					(SC16IS740_MSR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_SPR_ADDR							(7U)
#define SC16IS740_SPR_ADDR_REGSEL					(SC16IS740_SPR_ADDR<<SC16IS740_REGSEL_SHIFT)

/* TRANSMISSION CONTROL REGISTER */

#define SC16IS740_TCR_ADDR							(6U)
#define SC16IS740_TCR_ADDR_REGSEL					(SC16IS740_TCR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_TLR_ADDR_REGSEL					(SC16IS740_TLR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_TXLVL_ADDR_REGSEL					(SC16IS740_TXLVL_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_RXLVL_ADDR_REGSEL					(SC16IS740_RXLVL_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_EFCR_ADDR_REGSEL					(SC16IS740_EFCR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_DLL_ADDR_REGSEL					(SC16IS740_DLL_ADDR<<SC16IS740_REGSEL_SHIFT)
/* DIVISOR LATCH HIGH */
#define SC16IS740_DLH_ADDR							(1U)
#define SC16IS740_DLH_ADDR_REGSEL					(SC16IS740_DLH_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_EFR_ADDR_REGSEL					(SC16IS740_EFR_ADDR<<SC16IS740_REGSEL_SHIFT)
...
#define SC16IS740_XON1_ADDR_REGSEL					(SC16IS740_XON1_ADDR<<SC16IS740_REGSEL_SHIFT)
#define SC16IS740_XON2_ADDR							(5U)
#define SC16IS740_XON2_ADDR_REGSEL					(SC16IS740_XON2_ADDR<<SC16IS740_REGSEL_SHIFT)
#define SC16IS740_XOFF1_ADDR						(6U)
#define SC16IS740_XOFF1_ADDR_REGSEL					(SC16IS740_XOFF1_ADDR<<SC16IS740_REGSEL_SHIFT)
#define SC16IS740_XOFF2_ADDR						(7U)
#define SC16IS740_XOFF2_ADDR_REGSEL					(SC16IS740_XOFF2_ADDR<<SC16IS740_REGSEL_SHIFT)
