...
#define SC16IS740_IER_RXNEIT_MASK					(0X01<<IER_RXNEIT_POS)
#define SC16IS740_IER_TXEIT_POS						(1U)
#define SC16IS740_IER_TXEIT_MASK					(0X01<<IER_TXEIT_POS)
#define SC16IS740_IER_RXSTATUS_POS					(2U)
#define SC16IS740_IER_RXSTATUS_MASK					(0X01<<IER_RXSTATUS_POS)
#define SC16IS740_IER_MODEMSTATUS_POS				(3U)
#define SC16IS740_IER_MODEMSTATUS_MASK				(0X01<<IER_MODEMSTATUS_POS)
#define SC16IS740_IER_SLEEP_POS						(4U)
#define SC16IS740_IER_SLEEP_MASK					(0X01<<IER_SLEEP_POS)
#define SC16IS740_IER_XOFF_POS						(5U)
#define SC16IS740_IER_XOFF_MASK						(0X01<<IER_XOFF_POS)
#define SC16IS740_IER_nRTS_POS						(6U)
#define SC16IS740_IER_nRTS_MASK						(0X01<<IER_nRTS_POS)
#define SC16IS740_IER_nCTS_POS						(7U)
#define SC16IS740_IER_nCTS_MASK						(0X01<<IER_nCTS_POS)
...
#define SC16IS740_FCR_FIFOEN_MASK					(0X01U<<FCR_FIFOEN_POS)
#define SC16IS740_FCR_RXRST_POS						(1U)
#define SC16IS740_FCR_RXRST_MASK					(0X01U<<FCR_RXRST_POS)
#define SC16IS740_FCR_TXRST_POS						(2U)
#define SC16IS740_FCR_TXRST_MASK					(0X01U<<FCR_TXRST_POS)
#define SC16IS740_FCR_TXTL_POS						(4U)
#define SC16IS740_FCR_TXTL_MASK						(0X03U<<FCR_TXTL_POS)
#define SC16IS740_FCR_RXTL_POS						(6U)
#define SC16IS740_FCR_RXTL_MASK						(0X03U<<FCR_RXTL_POS)
...
#define SC16IS740_IIR_IST_MASK						(0X01U<<IIR_IST_POS)
#define SC16IS740_IIR_IPR_POS						(1U)
#define SC16IS740_IIR_IPR_MASK						(0X1FU<<IIR_IPR_POS)
#define SC16IS740_IIR_FIFOEN_POS					(6U)
#define SC16IS740_IIR_FIFOEN_MASK					(0X03U<<IIR_FIFOEN_POS)
...
#define SC16IS740_LCR_WORDLEN_MASK					(0X03<<LCR_WORDLEN_POS)
#define SC16IS740_LCR_STOP_POS						(2U)
#define SC16IS740_LCR_STOP_MASK						(0X01<<LCR_STOP_POS)
#define SC16IS740_LCR_PARITYEN_POS					(3U)
#define SC16IS740_LCR_PARITYEN_MASK					(0X01<<LCR_PARITYEN_POS)
#define SC16IS740_LCR_EVENPARITY_POS				(4U)
#define SC16IS740_LCR_EVENPARITY_MASK				(0X01<<LCR_EVENPARITY_POS)
#define SC16IS740_LCR_SETPARITY_POS					(5U)
#define SC16IS740_LCR_SETPARITY_MASK				(0X01<<LCR_SETPARITY_POS)
#define SC16IS740_LCR_SETBREAK_POS					(6U)
#define SC16IS740_LCR_SETBREAK_MASK					(0X01<<LCR_SETBREAK_POS)
#define SC16IS740_LCR_DIVLATCHEN_POS				(7U)
#define SC16IS740_LCR_DIVLATCHEN_MASK				(0X01<<LCR_DIVLATCHEN_POS)
...
#define SC16IS740_MCR_nRTS_MASK						(0X01<<MCR_nRTS_POS)
#define SC16IS740_MCR_TCRTCLEN_POS					(2U)
#define SC16IS740_MCR_TCRTCLEN_MASK					(0X01<<MCR_TCRTCLEN_POS)
#define SC16IS740_MCR_LOOPBACKEN_POS				(4U)
#define SC16IS740_MCR_LOOPBACKEN_MASK				(0X01<<MCR_LOOPBACKEN_POS)
#define SC16IS740_MCR_XONANY_POS					(5U)
#define SC16IS740_MCR_XONANY_MASK					(0X01<<MCR_XONANY_POS)
#define SC16IS740_MCR_IrDAEN_POS					(6U)
#define SC16IS740_MCR_IrDAEN_MASK					(0X01<<MCR_IrDAEN_POS)
#define SC16IS740_MCR_CLKDIV_POS					(7U)
#define SC16IS740_MCR_CLKDIV_MASK					(0X01<<MCR_CLKDIV_POS)
...
#define SC16IS740_LSR_RXDATA_MASK					(0X01<<LSR_RXDATA_POS)
#define SC16IS740_LSR_OVR_POS						(1U)
#define SC16IS740_LSR_OVR_MASK						(0X01<<LSR_OVR_POS)
#define SC16IS740_LSR_PARITY_POS					(2U)
#define SC16IS740_LSR_PARITY_MASK					(0X01<<LSR_PARITY_POS)
#define SC16IS740_LSR_FRAMING_POS					(3U)
#define SC16IS740_LSR_FRAMING_MASK					(0X01<<LSR_FRAMING_POS)
#define SC16IS740_LSR_BREAK_POS						(4U)
#define SC16IS740_LSR_BREAK_MASK					(0X01<<LSR_BREAK_POS)
#define SC16IS740_LSR_THRE_POS						(5U)
#define SC16IS740_LSR_THRE_MASK						(0X01<<LSR_THRE_POS)
#define SC16IS740_LSR_TXF_POS						(6U)
#define SC16IS740_LSR_TXF_MASK						(0X01<<LSR_TXF_POS)
#define SC16IS740_LSR_FIFOERR_POS					(7U)
#define SC16IS740_LSR_FIFOERR_MASK					(0X01<<LSR_FIFOERR_POS)
...
#define SC16IS740_MSR_DCTS_MASK						(0X01<<MSR_DCTS_POS)
#define SC16IS740_MSR_CTS_POS						(4U)
#define SC16IS740_MSR_CTS_MASK						(0X01<<MSR_CTS_POS)
...
#define SC16IS740_TCR_TXHALT_MASK					(0X01<<TCR_TXHALT_POS)
#define SC16IS740_TCR_TXRESUME_POS					(4U)
#define SC16IS740_TCR_TXRESUME_MASK					(0X01<<TCR_TXRESUME_POS)
...
#define SC16IS740_TLR_TXTL_MASK						(0X01<<TLR_TXTL_POS)
#define SC16IS740_TLR_RXTL_POS						(4U)
#define SC16IS740_TLR_RXTL_MASK						(0X01<<TLR_RXTL_POS)
...
#define SC16IS740_TXLVL_MASK						(0X7F)
...
#define SC16IS740_RXLVL_MASK						(0X7F)
...
#define SC16IS740_EFCR_9BITMODE_MASK				(0X01<<EFCR_9BITMODE_POS)
#define SC16IS740_EFCR_RXDISABLE_POS				(1U)
#define SC16IS740_EFCR_RXDISABLE_MASK				(0X01<<EFCR_RXDISABLE_POS)
#define SC16IS740_EFCR_TXDISABLE_POS				(2U)
#define SC16IS740_EFCR_TXDISABLE_MASK				(0X01<<EFCR_TXDISABLE_POS)
#define SC16IS740_EFCR_RTSCON_POS					(4U)
#define SC16IS740_EFCR_RTSCON_MASK					(0X01<<EFCR_RTSCON_POS)
#define SC16IS740_EFCR_RTSINVER_POS					(5U)
#define SC16IS740_EFCR_RTSINVER_MASK				(0X01<<EFCR_RTSINVER_POS)
#define SC16IS740_EFCR_IRDAMODE_POS					(7U)
#define SC16IS740_EFCR_IRDAMODE_MASK				(0X01<<EFCR_IRDAMODE_POS)
...
#define SC16IS740_EFR_SWFC_MASK						(0X07<<EFR_SWFC_POS)
#define SC16IS740_EFR_EFEN_POS						(4U)
#define SC16IS740_EFR_EFEN_MASK						(0X01<<EFR_EFEN_POS)
#define SC16IS740_EFR_SPCHAR_POS					(5U)
#define SC16IS740_EFR_SPCHAR_MASK					(0X01<<EFR_SPCHAR_POS)
#define SC16IS740_EFR_AnRTS_POS						(6U)
#define SC16IS740_EFR_AnRTS_MASK					(0X01<<EFR_AnRTS_POS)
#define SC16IS740_EFR_AnCTS_POS						(7U)
#define SC16IS740_EFR_AnCTS_MASK					(0X01<<EFR_AnCTS_POS)
